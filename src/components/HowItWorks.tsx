    ...
    <section
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          <p className="text-sm text-purple-400 uppercase tracking-wider font-medium mb-3">How It Works</p>
            ...
            <div key={step.num} className="relative">
              ...
              {i < STEPS.length - 1 && (
                <div className="hidden md:block absolute top-10 left-[calc(100%-16px)] w-full h-px z-0"
                  style={{ background: "linear-gradient(90deg, rgba(124,58,237,0.4), rgba(59,130,246,0.1))" }}/>
              )}

              <div className="glass-card rounded-2xl p-8 relative z-10 hover:border-white/15 transition-all duration-300 group">
                {/* Step number */}
                <div className="text-6xl font-black mb-4"
                  style={{ color: `${step.color}20`, WebkitTextStroke: `1px ${step.color}40` }}>
                  {step.num}
                </div>
